...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-15 15:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b4804b0c-db5a-414a-835d-1e8afd6cc371.git
$ cd b4804b0c-db5a-414a-835d-1e8afd6cc371
```
